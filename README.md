# OpenGuardrails Go SDK

[![Go Reference](https://pkg.go.dev/badge/https://github.com/openguardrails/openguardrails-go.svg)](https://pkg.go.dev/https://github.com/openguardrails/openguardrails-go)
[![Go Report Card](https://goreportcard.com/badge/https://github.com/openguardrails/openguardrails-go)](https://goreportcard.com/report/https://github.com/openguardrails/openguardrails-go)
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

OpenGuardrails Go Client - Context-aware AI guardrails based on LLM.
...
```bash
go get https://github.com/openguardrails/openguardrails-go
```
...
func main() {
    ...
    messages := []*openguardrails.Message{
        openguardrails.NewMessage("user", "User's question"),
        openguardrails.NewMessage("assistant", "AI assistant's answer"),
        openguardrails.NewMessage("user", "User's follow-up question"),
    }
